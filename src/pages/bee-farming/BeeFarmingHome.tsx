...
const HubHome: React.FC = () => {
  ...
  const navLinks = [
    { label: "Home", path: "/bee-farming" },
    { label: "Dashboard", path: "/bee-farming/dashboard" },
    { label: "Marketplace", path: "/bee-farming/marketplace" },
    { label: "Management", path: "/bee-farming/management" },
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Bee Farming Hub</h1>
                <p className="text-xs text-white text-opacity-80">Maximize Your Honey Production</p>
              </div>
            </div>
          </div>
